...
function addWalls(){
    ...
    walls.push(new THREE.Mesh(new THREE.CubeGeometry(plane.geometry.parameters.width, .1, 20), new THREE.MeshLambertMaterial({color: 0x00008B})));
    ...
    walls.push(new THREE.Mesh(new THREE.CubeGeometry( .1 , plane.geometry.parameters.height, 20), new THREE.MeshLambertMaterial({color: 0x00008B})));
